...
export type CreateConversationMutation = { createConversation: { id: string, createdAt: any, updatedAt: any, participants: Array<{ id: string, firstname: string, lastname?: string | null }>, messages: Array<{ id: string, type: MessageType, content: string, contentHistory: Array<string>, createdAt: any, updatedAt: any, from?: { id: string } | null }> } };
...
export type CreateMessageMutation = { createMessage: { id: string, type: MessageType, content: string, contentHistory: Array<string>, createdAt: any, updatedAt: any, from?: { id: string } | null, conversation?: { id: string } | null } };
...
export type DeleteMessageMutation = { deleteMessage: { id: string, type: MessageType, content: string, contentHistory: Array<string>, createdAt: any, updatedAt: any, from?: { id: string } | null, conversation?: { id: string } | null } };
...
export type MessageUpdatesSubscription = { messageUpdates: { type: UpdateType, message: { id: string, type: MessageType, content: string, updatedAt: any, createdAt: any, contentHistory: Array<string>, from?: { id: string } | null, conversation?: { id: string } | null } } };
