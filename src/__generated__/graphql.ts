...
export type CreateAnonymousMessageMutation = { createAnonymousMessage: { id: string, type: MessageType, content: string, createdAt: any, fromId: string } };
...
export type AnonymousMessageUpdatesSubscription = { anonymousMessageUpdates: { type: UpdateType, message: { id: string, type: MessageType, content: string, createdAt: any, fromId: string } } };
